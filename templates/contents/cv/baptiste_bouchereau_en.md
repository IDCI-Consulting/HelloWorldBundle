...
_2014_
  ...
  - 3 months internship in a startup, Santa Monica : created a news website
   - Designed the application
...
_2013_
  ...
  - Developed a Symfony2 bundle to generate web pages screenshots in different formats (.jpg, .gif, etc) and resolutions
   - Used PhantomJS
...
_2016_
  ...
  - Created a mini scratch game to celebrate birthdays in an original way, with CreateJs ([happy-birthday.pro](http://happy-birthday.pro))
...
_2015_
  ...
  - CPE Lyon Engineering degree : Development and Networks
