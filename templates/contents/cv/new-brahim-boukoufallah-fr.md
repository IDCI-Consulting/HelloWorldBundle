...
- Frontend avec **AngularJS** exploitant l'API sous forme de graphique
 ...
 - Réalisation de deux sites au **responsive design** pour des agences marketing ([www.tessicustomermarketing.fr](http://www.tessicustomermarketing.fr) et [pmc-net.net](http://pmc-net.net))
- CMS **WordPress**
...
- Micro-framework **Silex**
 ...
 - *2014* Développement de Mapyourstories, un prototype permettant la création de plans de métro personnalisables collaborativement et en temps réel
- Framework **MeteorJS**

 - *2013* **Stage à IDCI-Consulting** : Conception et réalisation d'une plate-forme permettant la gestion de note de frais
- Framework Symfony2
...
### FORMATIONS
 ...
 - *2014* **BTS SIO** (Service Informatique aux Organisations)


### PROJETS PERSONNELS

 - *2015* Réalisation d'un générateur de formulaire avec **Symfony2** (API REST)
 - *2014* Réalisation d'une application de gestion de commandes (restauration et bar) avec **AngularJS**
