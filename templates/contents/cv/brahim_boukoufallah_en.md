 ...
 * _System administration_ **HTTP server**: Apache, Nginx
 * **Configuration Management**: Ansible
 * _Langagues_ Java, PHP, HTML5, CSS3, Sass, JavaScript, Sql, NoSql, Shell Script
 * _Technologies_ **Framework backend**: Symfony2, Silex
 * **Framework frontend**: AngularJS
 * **Framework css**: Bootstrap, Foundation
 * **Template's engine**: Twig, Handlebars
 * **CMS**: WordPress
 * **Versioning**: Git, Svn
 * **Database**: Mysql, MongoDB
 * **Virtualisation**: Docker
 * **Project's management**: Redmine
 * **Others**: Ajax, jQuery, Gulp
 * _Graphism_ Gimp and Photoshop's notions
 * _Operating systems_ Windows, Linux (Debian et Ubuntu)

### PERSONAL EXPERIENCES

 * _2008 - 2013_ Filed polyvalent at Mcdonalds
