...
en "Marque Blanche" au service de votre groupe, association, entreprise, établissement, Etat ...

Il existe différents niveaux de ces services (Gratuit / Payant) suivant le type de votre organisation.
...
Rendez-vous à ici : [ http://www.google.com/apps/intl/fr/group/index.html]( http://www.google.com/apps/intl/fr/group/index.html)

![Renseignez votre nom de domaine](/images/blog/google-apps_dns.png)

Renseignez votre nom de domaine dans le champ
...
Voici votre tableau de bord qui vous permet de paramétrer toute la suite Google Apps.
...
Vous pouvez maintenant transformer l'URL de vos e-mails.
...
Sous un environnement Linux, vous pouvez accéder aux enregistrements DNS de n'importe quel domaine via la commande **dig**
