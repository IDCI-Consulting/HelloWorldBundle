...
Puis, IDCIStepBundle permet de faire des modifications directement dans la configuration, sans avoir besoin de modifier le Controller, ce qui permet plus de maintenabilité.
