...
Si vous n'avez pas encore installé WordPress, vous pouvez vous référer à notre article [Installer WordPress]({{ path('website_article', { file: 'install-wordpress' }) }}).
...
![WP Admin](/build/images/wp_install_8.png "WP Admin")
...
![BackOffice](/build/images/backoffice.png "BackOffice")
...
![Add post](/build/images/add_post.png "Add post")

Saisir un **titre** puis le **contenu**.

![New post](/build/images/new_post.png "New post")

Nous pouvons lui associer des catégories, qu'il est possible de créer à notre convenance.

![Post categories](/build/images/post_categories.png "Post categories")

Nous pouvons lui associer des mots-clés pour un meilleur référencement.

![Post tags](/build/images/post_tags.png "Post tags")
...
![Post actions](/build/images/post_actions.png "Post actions")
...
![Add page](/build/images/add_page.png "Add page")

Saisir un **titre** puis le **contenu**.

![New page](/build/images/new_page.png "New page")
...
![Page attributs](/build/images/page_attributs.png "Page attributs")
...
![Page actions](/build/images/post_actions.png "Page actions")
...
![Change editor mode](/build/images/editor_mode.png "Change editor mode")
...
![Advanced editor](/build/images/advanced_editor.png "Advanced editor")
...
![Add media](/build/images/add_media.png "Add Media")
...
![Permalink](/build/images/permalink.png "Permalink")
...
![Permalink menu](/build/images/permalink_menu.png "Permalink menu")

![Permalink format](/build/images/permalink_format.png "Permalink format")
...
![Permalink rewrite](/build/images/permalink_rewrite.png "Permalink rewrite")
...
![Manage comments](/build/images/manage_comments.png "Manage comments")
...
![Enable/Disable comments](/build/images/enable_disable_comments.png "Enable/Disable comments")
...
![Display screen options](/build/images/display_screen_options.png "Display screen options")

Ici, cochez l'option **discussion**.

![Screen options](/build/images/screen_options.png "Screen options")
...
![Discussion box](/build/images/discussion_box.png "Discussion box")
...
![Comment user data](/build/images/comment_user_data.png "Comment user data")
...
![Moderate comments](/build/images/moderate_comments.png "Moderate comments")
...
![Themes](/build/images/themes.png "Themes")
...
![Plugins](/build/images/plugins.png "Plugins")
...
![Users](/build/images/users.png "Users")
...
![General parameters](/build/images/general.png "General parameters")

![General parameters options](/build/images/general_options.png "General parameters options")
...
![Lecture](/build/images/lecture.png "lecture")
...
![Homepage parameters](/build/images/homepage_parameters.png "Homepage parameters")
...
Si vous avez des questions ou souhaitez une formation plus avancée sur WordPress, n'hésitez pas à [nous contacter]({{ path('website_contact') }} "Contactez-nous").
