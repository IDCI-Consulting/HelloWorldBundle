...
![Google apps logo](/build/images/google-apps_logo.jpg "Google Apps")
...
![Renseignez votre nom de domaine](/build/images/google-apps_dns.png)

Renseignez votre nom de domaine dans le champ suivant.

![Inscription aux Google Apps](/build/images/google-apps_registration.png)
...
![Edition du champ DNS TXT](/build/images/ovh_dns_txt.png "Edition du champ DNS TXT")
...
!["Edition du champ DNS MX"](/build/images/ovh_dns_mx.png "Edition du champ DNS MX")
...
![Champs DNS MX](/build/images/ovh_zone_dns.png "Champs DNS MX")
...
![Champs DNS CNAME](/build/images/ovh_dns_cname.png "Champs DNS CNAME")

Création d'un alias mail.monentreprise.fr sous forme de champ DNS CNAME vers ghs.google.com.

![Tableau de bord](/build/images/google-apps_dashboard.png "Tableau de bord")

Voici notre tableau de bord, il permet de paramétrer toute la suite Google Apps.

![Parametrage des emails](/build/images/google-apps_params_email.png "Parametrage des emails")

Rendez vous dans l'onglet "Paramètres", dans le service "Email" puis sur "Modifier l'URL"

![Parametrage des emails](/build/images/google-apps_webmail_url.png "Parametrage des emails")
...
!["Ninjas Gmail"](/build/images/ninjas-sprited.jpg)
