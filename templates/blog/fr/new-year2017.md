...
**[Baptiste Boucherau]({{ path('website_cv',{theme: 'idci', name: 'baptiste_bouchereau'}) }} "Baptiste Boucherau")** est devenu co-gérant cette année.
...
**[Brahim Boukoufallah]({{ path('website_cv',{theme: 'idci', name: 'brahim_boukoufallah'}) }} "Brahim Boukoufallah")** a rejoint l'équipe plus durablement en signant un CDI après un stage et une alternance chez IDCI.
Il est devenu également formateur à l'INSEEC et à la 3WAcademy.

**[Eddie Barraco]({{ path('website_cv',{theme: 'idci', name: 'eddie_barraco'}) }} "Eddie Barraco")** travaille en alternance chez IDCI-Consulting depuis cette année pour se former au métier de développeur.

![IDCI team](/build/images/new-year2017-team.jpg "IDCI team")
...
Nous avons changé de locaux et terminé notre installation dans un nouvel espace de travail, qui correspond mieux à notre philosophie et au besoin de l'équipe.
...
Alors que nous proposions des offres d'hébergement de sites internet, nous avons fait le choix d'arrêter ce service pour nous recentrer sur nos principales activités à savoir le conseil, le développement web et la formation.
Les derniers site web client ont été migré cette année 2016.
