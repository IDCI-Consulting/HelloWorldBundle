...
![AMPP logos](/build/images/apache-mysql-php-phpmyadmin.png)
...
![phpinfo](/build/images/it_works_apache.png)
...
![phpinfo](/build/images/phpinfo.png)
...
![Virtual Hosting](/build/images/virtual_hosting.png)
...
![DNS resolution](/build/images/dns_resolution.png "DNS resolution")
...
![Privileges](/build/images/pma_privileges.png "Go to the Privilege tab")

![Nouveau utilisateur](/build/images/pma_new_user.png "New user")

![Ajouter utilisateur](/build/images/pma_add_new_user.png "Add a new user")

![Go](/build/images/pma_go.png "Validate")
...
If you need assistance arranging a development environment for your team, or help deploying and migrating your website, you can [contact us]({{ path('website_contact') }} "Contact us").
